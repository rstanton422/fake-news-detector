...
def article_analyzer(text:str) -> dict:
    """
    Analyze input text and return whether fake news was predicted or not

    Args:
        text: article text

    Return:
        dictionary containing label and prediction confidence
    """
...
#======================================================================
# DON'T NEED TO KEEP CODE BELOW BUT I MAY WANT REFERENCE IT IN FUTURE
#======================================================================
